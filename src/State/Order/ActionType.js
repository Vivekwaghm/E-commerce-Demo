export const CREATE_ORDER_REQUEST = 'CREATE_OREDER_REQUEST'
export const CREATE_ORDER_SUCCESS = 'CREATE_OREDER_SUCCESS'
export const CREATE_ORDER_FAILURE = 'CREATE_OREDER_FAILURE'
