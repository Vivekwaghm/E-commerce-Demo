...
export default function ProductDetails() {
  ...
  const handleAddtoCart=()=>{
    ...
    console.log('addtocart data _ ',data)
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-60 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">568 Review</p>
              </div>
...
{/** Rating and Reviews*/}
        <section>
            <h1 className="font-semibold text-lg pb-4">Review and Rating</h1>
                ...
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <p className="opacity-60"> 14556 Ratings</p>
                        </div>
